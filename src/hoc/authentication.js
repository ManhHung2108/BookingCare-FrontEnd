...
// - wrapperDisplayNamelà tên hiển thị của HOC khi xem trong DevTools.
// - redirectPathđường dẫn sẽ được chuyển hướng nếu người dùng không xác thực.
...
// - redirectPath ở đây có thể trả về đường dẫn từ tham số truyền vào hoặc sử dụng trình trợ giúp để lấy đường dẫn từ
